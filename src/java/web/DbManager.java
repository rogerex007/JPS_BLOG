...
public class DbManager implements IRepo {
    ...
    public int Login(String username, String password) {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=blogstrap", "sa", "2831Roger");
    ...
    public int Register(User user) {
        try {
            int flag = 0;
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            con = DriverManager.getConnection("jdbc:sqlserver://localhost;databaseName=blogstrap", "sa", "2831Roger");

            PreparedStatement val = con.prepareStatement("SELECT COUNT(*) FROM Users WHERE Username=? OR Email=?");
            val.setString(1, user.Username);
            val.setString(2, user.Email);
    ...
    @Override
    public List<Post> GetAllMyPost(String username) {
        try {
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            con = DriverManager.getConnection("jdbc:sqlserver://localhost;databaseName=blogstrap", "sa", "2831Roger");
            ...
            PreparedStatement sql = con.prepareStatement("SELECT * FROM Posts WHERE PostAuthor=?");
            sql.setString(1, username);
    ...
    public int InsertPost(Post post) {
        try {
            ...
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            con = DriverManager.getConnection("jdbc:sqlserver://127.0.0.1:1433;databaseName=blogstrap", "sa", "2831Roger");
